...
# Block 1st elements for now: re-pick of variables between Gold futures and Gold ETF

# 1.Gold current price in USD per 0.1 ounce, present by SPDR Gold Shares (GLD)
# (data periods: 2004-11 to recent)
