...
**Use links to directly download data set from Source**
For the variable this research mainly focus on:
```{r}
...
```
As above, we could have all 17 variables in visualization format individually.
